...
<div class="row">
    <div class="col-lg-12">
        <div class="card card-danger card-outline">
            <div class="card-body">
            <form action="{{ route('editprofile.update', Auth::user()->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('put')
                    <div class="mb-3">
                    <div class="form-group">
                                    ...
                                    <div class="setting_logo">
                                        <img style="border-radius: 35px;" src="{{asset(Auth::user()->image)}}" id="image" alt="" height="200px">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control border-danger text-lg" name="name" id="name" type="text" value="{{Auth::user()->name}}">
                        </div>

                        <div class="form-group">
                            <label for="recipient-name" style="color:#ff2832;" class="col-form-label">Email</label>
                            <input class="form-control border-danger text-lg" name="email" id="email" type="email" value="{{Auth::user()->email}}">
                        </div>
