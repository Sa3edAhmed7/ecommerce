                            ...
                            @foreach ($orders as $order)
                              ...
                              <tr>
                                <td class="py-5 text-center text-bold">{{ $i }}</td>
                                    ...
                                    <td class="py-5 text-center text-bold" style="color:#ffffff; background-color:#fd7e14;">{{$order->status }}</td>
                                    @elseif(($order->status) == 'approve')
                                    <td class="py-5 text-center text-bold" style="color:#ffffff; background-color:#20c997;">{{$order->status }}</td>
                                    @else 
                                    <td class="py-5 text-center text-bold" style="color:#ffffff; background-color:#e74c3c;">{{$order->status }}</td>
                                    @endif
                                    ...
                                    <a class="btn btn-sm btn-info-gradient" style="color:#ff2832;"
                                            href="orderdetails/{{ $order['id'] }}" title="عرض"><i class="fa fa-eye"></i></a>   
                                        </form>  
                                      </td>
                              </tr>
                              @endforeach
