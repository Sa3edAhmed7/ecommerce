...
<div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0" style="color:#ff2832;">Edit Page {{ $page->id }}</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
            ...
            <div class="card-body">
                ...
                @method('put')
                        <div class="form-group">
                            ...
                            <input class="form-control border-danger text-lg" name="title" id="title" type="text" value="{{$page->title}}">
                        </div>
                        <div class="form-group">
                            <label for="message-text" style="color:#ff2832;" class="col-form-label">Content:</label>
                            <textarea class="form-control border-danger text-lg" id="summernote" name="content" cols="30" rows="10">{{$page->content}}</textarea>
                        </div>
