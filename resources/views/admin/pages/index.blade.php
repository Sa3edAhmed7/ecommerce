                    ...
                    <div class="row">
                      <div class="col-12">
                          ...
                          <div class="card-header">
                            <h3 class="card-title" style="color:#ff2832;">Pages</h3>
                          </div>
                          <!-- /.card-header -->
                            ...
                            <table id="example2" class="table table-bordered table-hover">
                              ...
                              <tr>
                                ...
                                <th class="wd-5p border-bottom-0 text-center" style="color:#ff2832;">title</th>
                            ...
                            @foreach ($page as $x)
                              ...
                              <tr>
                                <td class="py-5 text-center">{{ $i }}</td>
                                    <td class="py-5 text-center">{{ $x->title }}</td>
                                    <td class="py-5 text-center">
                                    <form action="{{ route('page.destroy',$x->id) }}" method="POST">
                                                    @csrf
                                                    @method('delete')
                                                    <button class="btn btn-sm btn-info-gradient" style="color:#ff2832;">
                                                    <i class="fas fa-trash"></i></button>
                                            <a class="btn btn-sm btn-info-gradient" style="color:#ff2832;"
                                                href="{{ route('page.edit', $x->id) }}" title="تعديل"><i class="fa fa-pen"></i></a>
                                                <a class="btn btn-sm btn-info-gradient" style="color:#ff2832;"
                                                href="{{ route('page.show', $x->id) }}" title="عرض"><i class="fa fa-eye"></i></a>   
                                                </form>     
                                    </td>
                              </tr>
                              @endforeach
