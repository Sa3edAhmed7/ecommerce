                    ...
                    <div class="row">
                      <div class="col-12">
                          ...
                          <div class="card-header">
                            <h3 class="card-title" style="color:#ff2832;">Users</h3>
                          </div>
                          <!-- /.card-header -->
                            ...
                            <table id="example2" class="table table-bordered table-hover">
                              ...
                              <tr>
                                ...
                                <th class="wd-5p border-bottom-0 text-center" style="color:#ff2832;">User Name</th>
                                <th class="wd-5p border-bottom-0 text-center" style="color:#ff2832;">Email</th>
                                <th class="wd-5p border-bottom-0 text-center" style="color:#ff2832;">User Type</th>
                            ...
                            @foreach ($users as $user)
                              ...
                              <tr>
                                <td class="py-5 text-center">{{ $i }}</td>
                                    <td class="py-5 text-center">{{ $user->name }}</td>
                                    <td class="py-5 text-center">{{ $user->email}}</td>
                                    <td class="py-5 text-center">{{ $user->type }}</td>
                                    ...
                                    <form action="{{ route('users.destroy',$user->id) }}" method="POST">
                                            ...
                                            <a class="btn btn-sm btn-info-gradient" style="color:#ff2832;"
                                                href="{{ route('users.edit', $user->id) }}" title="تعديل"><i class="fa fa-pen"></i></a>
