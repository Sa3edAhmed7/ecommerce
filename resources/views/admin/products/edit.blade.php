...
<div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0" style="color:#ff2832;">Edit Products Page {{ $product->id }}</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
                    ...
                    <div class="mb-3">
                      <div class="col-sm-12 col-md-12"><h6 class="tx-center tx-bold" style="color:#000000;">ProductImage</h6>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control border-danger text-lg" name="name" id="name" type="text" value="{{ $product->name }}">
                        </div>
                        <div class="form-group">
                            <label for="message-text" style="color:#ff2832;" class="col-form-label">ProductDescription</label>
                            <textarea class="form-control border-danger text-lg" id="description" name="description">{{ $product->description }}</textarea>
                        </div>
                        <div class="form-group">
                            <label for="recipient-name" style="color:#ff2832;" class="col-form-label">Price</label>
                            <input class="form-control border-danger text-lg" name="price" id="price" type="text" value="{{ $product->price }}">
                        </div>
                        <div class="form-group">
                            <label for="recipient-name" style="color:#ff2832;" class="col-form-label">Offer</label>
                            <input class="form-control border-danger text-lg" name="offer" id="offer" type="text" value="{{ $product->offer }}">
                        </div>
                        <div class="form-group">
